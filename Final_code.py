...
while True:
    ...
    for rect in rects:
        ...
        #cv2.putText(frame,"x: {}".format(x),(300, 80),cv2.FONT_HERSHEY_SIMPLEX,0.7,(0, 0, 255),2)
        #cv2.putText(frame,"y: {:.2f}".format(y),(300, 30),cv2.FONT_HERSHEY_SIMPLEX,0.7,(0, 0, 255),2)
        #cv2.putText(frame,"Left: {}".format(tLeftBlink),(10, 30),cv2.FONT_HERSHEY_SIMPLEX,0.7,(0, 0, 255),2)
        #cv2.putText(frame,"right: {}".format(tRightBlink),(10,80 ),cv2.FONT_HERSHEY_SIMPLEX,0.7,(0, 0, 255),2)
...
# python Final_code.py --shape-predictor eye-detection-model.dat
